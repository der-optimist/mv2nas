...
echo $msg
curl -X POST -H "Authorization: Bearer ${ha_token}" -H "Content-Type: application/json" -d '{"message":"test"}' http://homeassistant.fritz.box:8123/api/events/kodi_plattenplatz
#
echo ' '
echo '--- Fertig ---'
date
