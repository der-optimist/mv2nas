...
rsync --progress --remove-source-files *Die*Toten*Bodensee* ${dir_nas_media}/TVSendungen/90_-_Die_Toten_vom_Bodensee 2>/dev/null
#
...
#
echo 'Samstagskrimi'
rsync --progress --remove-source-files *'Samstagskrimi'* ${dir_nas_media}/TVSendungen/90_-_Sonstige_Samstagskrimis 2>/dev/null
#
echo 'Soko Leipzig'
...
rename 's/ - Polizeiruf 110//' *
#
cd ${dir_nas_media}/TVSendungen/90_-_Sonstige_Samstagskrimis
rename 's/ - Der Samstagskrimi//' *
#
cd ${dir_nas_media}/TVSendungen/45_-_Soko_Leipzig
rename 's/ - SOKO Leipzig//' *
#
