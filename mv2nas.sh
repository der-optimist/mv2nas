...
#
echo 'Die Chefin'
rsync --progress --remove-source-files *ZDF*'Die Chefin'* ${dir_nas_media}/TVSendungen/60_-_Die_Chefin 2>/dev/null
#
echo 'Die Spezialisten'
rsync --progress --remove-source-files *ZDF*'Die Spezialisten'* ${dir_nas_media}/TVSendungen/45_-_Die_Spezialisten 2>/dev/null
#
...
rsync --progress --remove-source-files *ZDF*'Letzte Spur Berlin'* ${dir_nas_media}/TVSendungen/45_-_Letzte_Spur_Berlin 2>/dev/null
#
echo 'Ein starkes Team'
rsync --progress --remove-source-files *ZDF*starkes*Team* ${dir_nas_media}/TVSendungen/90_-_Ein_starkes_Team 2>/dev/null
#
echo 'Polizeiruf'
...
#
echo 'Soko Stuttgart'
rsync --progress --remove-source-files *ZDF*'SOKO Stuttgart'* ${dir_nas_media}/TVSendungen/45_-_Soko_Stuttgart 2>/dev/null
#
echo 'Sonstige SOKOs'
rsync --progress --remove-source-files *ZDF*SOKO* ${dir_nas_media}/TVSendungen/45_-_Sonstige_Sokos 2>/dev/null
#
echo 'Staatsanwalt'
rsync --progress --remove-source-files *ZDF*'Der Staatsanwalt'* ${dir_nas_media}/TVSendungen/60_-_Staatsanwalt 2>/dev/null
#
echo 'Tatort'
